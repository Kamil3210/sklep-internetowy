...
const pool = new Pool({
    user: 'kamil_user',            // Użytkownik PostgreSQL
    host: 'localhost',
    database: 'order_service_db',  // Nazwa nowej bazy danych
    password: 'supersecretpassword', // Hasło użytkownika
    port: 5433,                    // Port hosta, na którym działa kontener PostgreSQL
});
